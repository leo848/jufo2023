...
MODEL_NAME = "models/15Mendgame-512neurons-4layers.h5"
...
MODEL_INPUT = "npy_files/15M_endgame_neural_input/{file}"
MODEL_OUTPUT = "npy_files/15M_endgame_neural_output/{file}"

TENSORBOARD = True

TOTAL_DATA_SIZE = 15_000_000
AMOUNT_OF_FILES = 30
